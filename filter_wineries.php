...
<div style = 'height:85vh; position:relative'>
    ...
    <div class = "tab">
        ...
        <div class = "tab searchtab">
            ...
            <input type="text" id="search2" class = "searchbar" placeholder="Search for a Street">
            <label class = "searchlabel">Suburb:</label>
            <input type="text" id="search3" class = "searchbar" placeholder="Search for a Suburb">
            <label class = "searchlabel">Province:</label>
            <input type="text" id="search4" class = "searchbar" placeholder="Search for a Province">
            <label class = "searchlabel">Country:</label>
            <input type="text" id="search5" class = "searchbar" placeholder="Search for a Country">
            <label class = "searchlabel">Verified:</label>
            <input type="text" id="search6" class = "searchbar" placeholder="Search for a Verification">
            ...
            <div class = "tab filtertab">
                ...
                <label class = "filtertitle">Suburb:</label><br>
                    <div class="dropdown">
                        ...
                        <div id="suburbDropdown" class="dropdown-content" style="overflow-y:scroll; height:75px"></div>
                    </div>
                </div>
                ...
                <div id="provinces">
                    ...
                    <div class="dropdown">
                        ...
                        <div id="provinceDropdown" class="dropdown-content" style="overflow-y:scroll; height:75px"></div>
                    </div>
                </div>
                ...
                <div id="countries">
                    ...
                    <div class="dropdown">
                        ...
                        <div id="countryDropdown" class="dropdown-content" style="overflow-y:scroll; height:75px"></div>
                    </div>
                </div>

                <div id="verified">
                    <label class = "filtertitle">Verification:</label><br>
                    <div class="dropdown dropdown-content">
                        <div style = "border-bottom:1px solid #212529">
                            <input type="checkbox" id="verified1" onclick="filterWines()" value = "1" style = "margin-left:8px">
                            <label class="filterlabel" >Verified</label><br>
                        </div>
                        <input type="checkbox" id="verified2" onclick="filterWines()" value = "0" style = "margin-left:8px">
                        <label class="filterlabel">Unverified</label>
                    </div>
                </div>
...
<script>
    ...
    function addSuburbs(j)//Function to add all suburbs to filters
    {
        ...
        {
            $('#suburbDropdown').append('<div id = "' + j[i].Suburb + '" class = soption style = "border-bottom:1px solid #212529"><input type="checkbox" style = "margin-left:5px" id="suburb' + i.toString() + '" onclick="filterWines()" value = "' + j[i].Suburb + '"><label for="t' + i.toString() +'" class="filterlabel">' + j[i].Suburb +  '</label></div>')
        }
    }
     ...
     function addProvinces(j)//Function to add all provinces to filters
    {
        ...
        for(var i = 0; i < j.length; i++)
        {
            $('#provinceDropdown').append('<div id = "' + j[i].Province + '" class = poption style = "border-bottom:1px solid #212529"><input type="checkbox" style = "margin-left:5px" id="province' + i.toString() + '" onclick="filterWines()" value = "' + j[i].Province + '"><label class="filterlabel">' + j[i].Province + '</label></div>')
        }
    }
    ...
    function addCountries(j)//Function to add all countries to filters
    {
        ...
        for(var i = 0; i < j.length; i++)
        {
            $('#countryDropdown').append('<div id = "' + j[i].Country + '" class = coption style = "border-bottom:1px solid #212529"><input type="checkbox" style = "margin-left:5px" id="country' + i.toString() + '" onclick="filterWines()" value = "' + j[i].Country + '"><label class="filterlabel">' + j[i].Country + '</label></div>')
        }
    }
    ...
    function reset()//function implements filter reset button click
    {
        ...
        document.getElementById('verified1').checked=false;
        document.getElementById('verified2').checked=false;
    ...
    function filterWines() //Function to filter table
    {
        ...
        var suburbInput = [], provinceInput = [], countryInput = [], found = [1,1,1,1], verificationInput = [];
        ...
        {
            verificationInput.push(1);
        }
        if(document.getElementById("verified2").checked)
        {
            verificationInput.push(0);
        }
        ...
        for (var i = 0; i < tr.length; i++)
        {
            _td[0] = tr[i].getElementsByTagName("td")[3];//SUBURBS
            _td[1] = tr[i].getElementsByTagName("td")[4];//PROVINCES
            _td[2] = tr[i].getElementsByTagName("td")[5];//COUNTRIES
            _td[3] = tr[i].getElementsByTagName("td")[6];//VERIFICATION
            ...
            if (_td[0]) 
            {
                ...
                for (var k = 0; k < verificationInput.length; k++)
                {
                    if (_tv[3].toUpperCase().indexOf(verificationInput[k]) <= -1)
                    {
                        found[3] = 0;
                    }  
                    if (_tv[3].toUpperCase().indexOf(verificationInput[k]) > -1)
    ...
    var numSuburbs, numCountries, numProvinces;

    var str = "SELECT Winery_id AS ID, Name, Street_name AS Street, Suburb, Province, Country, Verified FROM Winery";
    getWineDB(str,convert);

    str = "SELECT Suburb FROM Winery GROUP BY Suburb ORDER BY Suburb";
    getWineDB(str,addSuburbs);

    str = "SELECT Province FROM Winery GROUP BY Province ORDER BY Province";
    getWineDB(str,addProvinces);

    str = "SELECT Country FROM Winery GROUP BY Country ORDER BY Country";
